...
INSERT INTO `hospital` (`hospital_id`, `hospital_name`, `hospital_shortName`, `pincode`, `hospital_incharge_name`, `hospital_incharge_mobile`, `hospital_incharge_phone`, `hospital_email`, `owner_name`, `generalBeds`, `dayCareBeds`, `icuBeds`, `iccuBeds`, `hduBeds`, `majorOts`, `minorOts`, `hospitalAddress`, `latitude`, `longitude`, `panNumber`, `clinicalRegistrationNumber`, `panCardHolderName`, `serviceTaxRegistrationNumber`, `branchAddress`, `bankAccountNumber`, `ifsc_code`, `payeeName`, `numberOfFullTimePhysicians`, `remarks`, `fullTimeConsultants`, `partTimeConsultants`, `visitingConsultants`, `dutyDoctors`, `generalNurses`, `bank_name`, `pharmacy_type`, `state`, `district_id`, `location`, `hospital_type`, `nabh`) VALUES
(9, 'Apollo Nursing Home', 'Apollo', 600099, 'Swathy', '9840595496', NULL, 'swathy.sumithra@gmail.com', 'Edwin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(16, 'Akn Nursing Home', 'Akn', 600011, 'Yuvarani', '9840595496', '04425502946', 'yuvaammu3@gmail.com', 'Edwin', 23, 21, 232, 42, 2, 34, 24, '22,chennai,99', 23.4667, 0, '234512345677fg', 'Gs34sdh', 'Fgh', '335gfsd', 'Dshj', '113563`', '2bb5', 'Wg', 45, '34sg', 34, 34, 34, 232, 35, 'Iob', 'DSSG', 'TAMILNADU', 17, 'ASSGMK', 'private', 'FINAL');
...
INSERT INTO `scheme` (`scheme_id`, `scheme_name`, `description`, `maximum_amount`, `creation_date`, `updation_date`, `fund_allocated`, `created_by`, `updated_by`, `requiredFile_url1`, `requiredFile_url2`, `requiredFile_url3`, `type_id`, `file_url`) VALUES
...
(81, 31, '{\"role\":\"3\",\"roleText\":\"Hospital\",\"name\":\"Yuvarani\",\"email\":\"yuvaammu3@gmail.com\"}', '127.0.0.1', 'Chrome 65.0.3325.181', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', 'Windows 7', '2018-03-26 11:59:25'),
(82, 23, '{\"role\":\"1\",\"roleText\":\"Administrator\",\"name\":\"Swarna Swapna\",\"email\":\"swarna.ilas@gmail.com\"}', '127.0.0.1', 'Chrome 65.0.3325.181', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', 'Windows 7', '2018-03-26 12:28:19'),
(83, 31, '{\"role\":\"3\",\"roleText\":\"Hospital\",\"name\":\"Yuvarani\",\"email\":\"yuvaammu3@gmail.com\"}', '127.0.0.1', 'Chrome 65.0.3325.181', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', 'Windows 7', '2018-03-26 13:32:12');
...
--
ALTER TABLE `hospital`
  ADD CONSTRAINT `hospital_ibfk_1` FOREIGN KEY (`district_id`) REFERENCES `district` (`district_id`);
